...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Create an array of the three UIViewControllers.
    NSArray *viewControllers = [NSArray arrayWithObjects:tempvc, distvc, timevc, nil];
    [tabBarController setViewControllers:viewControllers];
    
    // Set TapBarController as the root controller.
